...
void soilsensor_init(void)
{
  /*
    ...
    ESP_ERROR_CHECK(gpio_set_level((gpio_num_t)GROVE_DIGITAL_INPUT, 0));
    // ESP_ERROR_CHECK(gpio_set_level((gpio_num_t)GROVE_DIGITAL_INPUT, 1));
    */
...
void soilsensor_deinit(void)
{
  /*
    ESP_ERROR_CHECK(gpio_set_level((gpio_num_t)GROVE_DIGITAL_INPUT, 0));
    ESP_ERROR_CHECK(gpio_reset_pin((gpio_num_t)GROVE_DIGITAL_INPUT));
  */
